      ...
      <AccountSection title="Account details">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
          ...
          <dl className="grid min-w-0 flex-1 gap-4 sm:grid-cols-2">
            <div><dt className="text-sm text-slate-500">Display name</dt><dd className="mt-1 truncate font-semibold text-slate-900 dark:text-slate-100">{displayName}</dd></div>
            <div><dt className="text-sm text-slate-500">Email</dt><dd className="mt-1 truncate font-semibold text-slate-900 dark:text-slate-100">{profile.email}</dd></div>
